 ...
 */
public class NHSFLSEImageActivity extends BaseActivity implements CardViewAdapter.Clicklistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable bitmap = getResources().getDrawable(R.drawable.nhsf_lse);
