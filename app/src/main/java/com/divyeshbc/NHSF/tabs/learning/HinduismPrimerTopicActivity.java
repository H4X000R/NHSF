 ...
 */
public class HinduismPrimerTopicActivity extends BaseActivity implements OnPageChangeListener {

    private PDFView mPDFView;

    public static final String SAMPLE_FILE = "What is Hinduism.pdf";
