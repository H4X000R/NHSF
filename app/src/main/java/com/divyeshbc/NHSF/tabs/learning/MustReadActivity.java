 ...
 */
public class MustReadActivity extends BaseActivity implements RecyclerViewAdapterMustRead.ClickListener {

    private RecyclerView mRecyclerView;

    //Creating an instance of the adapter object
    private RecyclerViewAdapterMustRead adapter;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.must_read);
        ...
        adapter=new RecyclerViewAdapterMustRead(this, getData());
    ...
    public static List<Information> getData() {
        ...
        String[] text = {"Scriptures", "Hinduism Made Simple", "Why Do We?"};
        String[] subtext = {"Bhagavad Gita", "What is Hinduism?", "Some Core Questions Answered"};
