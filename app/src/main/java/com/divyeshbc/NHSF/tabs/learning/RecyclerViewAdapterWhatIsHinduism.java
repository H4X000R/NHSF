 ...
 */
public class RecyclerViewAdapterWhatIsHinduism extends RecyclerView.Adapter<RecyclerViewAdapterWhatIsHinduism.MyViewHolder> {
    ...
    public RecyclerViewAdapterWhatIsHinduism(Context context, List<SubInformation> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (position) {
                    case 0:
                        //Intent to 14 Questions Booklet by HT PDF
                        intent = new Intent(context, QuestionsActivity.class);
                        break;

                    case 1:
                        //Intent to Hindu Basics PDF
                        intent = new Intent(context, HinduBasicsActivity.class);
                        break;

                    case 2:
                        //Intent to Real Questions PDF
                        intent = new Intent(context, RealQuestionsActivity.class);
                        break;

                    case 3:
                        //Intent to What is Hinduism - A Primer to the Topic PDF
                        intent = new Intent(context, HinduismPrimerTopicActivity.class);
                        break;
