 ...
 */
public class WhatIsHinduismActivity extends BaseActivity implements RecyclerViewAdapterWhatIsHinduism.ClickListener {

    private RecyclerView mRecyclerView;

    //Creating an instance of the adapter object
    private RecyclerViewAdapterWhatIsHinduism adapter;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.hinduism_made_simple);
        ...
        mRecyclerView=(RecyclerView) findViewById(R.id.hinduismSimple_recycler_view);
        ...
        adapter=new RecyclerViewAdapterWhatIsHinduism(this, getData());
    ...
    public static List<SubInformation> getData() {
        ...
        String[] text = {"14 Questions Booklet by HT", "Hindu Basics", "Real questions about Hinduism", "What is Hinduism?"};
