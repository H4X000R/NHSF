...
/**
 * Created by DivyeshBC on 19/11/15.
 */
public class ATrulySelflessBeingActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=aZCmE4esCzI&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=9";
