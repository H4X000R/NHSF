 ...
 */
public class EnoughFoodActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=Xi38ZtG4NhM&index=2&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId";
