 ...
 */
public class HelpTheHomelessActivity extends BaseActivity implements OnPageChangeListener {

    private PDFView mPDFView;

    public static final String SAMPLE_FILE = "Help The Homeless Campaign.pdf";
