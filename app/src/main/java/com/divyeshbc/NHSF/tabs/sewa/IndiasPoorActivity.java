 ...
 */
public class IndiasPoorActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=LcJ1iFPKm00&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=7";
