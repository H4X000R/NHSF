 ...
 */
public class MakeTheHomelessActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=GoGtaXt5f1w&index=4&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId";
