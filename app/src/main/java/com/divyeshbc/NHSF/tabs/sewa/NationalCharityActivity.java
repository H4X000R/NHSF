 ...
 */
public class NationalCharityActivity extends BaseActivity implements OnPageChangeListener {

    private PDFView mPDFView;

    public static final String SAMPLE_FILE = "Divya Sewa Foundation.pdf";
