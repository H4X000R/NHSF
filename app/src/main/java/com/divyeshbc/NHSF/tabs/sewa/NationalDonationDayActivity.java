 ...
 */
public class NationalDonationDayActivity extends BaseActivity implements OnPageChangeListener {

    private PDFView mPDFView;

    public static final String SAMPLE_FILE = "National Donation Day.pdf";
