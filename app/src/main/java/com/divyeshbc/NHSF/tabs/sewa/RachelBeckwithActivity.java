 ...
 */
public class RachelBeckwithActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=nC_vXAF-pBM&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=8";
