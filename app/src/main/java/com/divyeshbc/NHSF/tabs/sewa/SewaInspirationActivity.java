 ...
 */
public class SewaInspirationActivity extends BaseActivity implements RecyclerViewAdapterSewaInspiration.ClickListener {

    private RecyclerView mRecyclerView;

    //Creating an instance of the adapter object
    private RecyclerViewAdapterSewaInspiration adapter;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.sewa_inspiration);
        ...
        mRecyclerView=(RecyclerView) findViewById(R.id.sewaInpspiration_recycler_view);
        ...
        adapter=new RecyclerViewAdapterSewaInspiration(this, getData());
    ...
    public static List<SubInformation> getData() {
        ...
        String[] text = {"Sewa Videos", "Sewa Quotes"};
