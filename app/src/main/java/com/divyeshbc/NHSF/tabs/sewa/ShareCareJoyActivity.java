 ...
 */
public class ShareCareJoyActivity extends BaseActivity {

    private WebView mWebView;

    String url =  "http://www.youtube.com/watch?v=HkuKHwetV6Q&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=5";
